...
- **Honesty over polish.** Benchmark caps, EPSC weights, and the SVT valuation are **illustrative** —
...
- I NEVER present illustrative benchmarks/weights/SVT as an actual proxy-advisor score, and I never claim
