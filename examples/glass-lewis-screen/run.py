...
.hl-tag{color:#6d8ba0;font-size:11px;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px}.headline p{margin:0}.vd{font-weight:800}
...
.k-v{font-size:20px;font-weight:700;margin:2px 0}.k-s{color:#8fb0c6;font-size:11px}
.tile{background:#0a1f2c;border:1px solid #14364a;border-radius:8px;padding:16px;margin:14px 0}
...
.adv-lens{color:#6d8ba0;font-size:11px;margin-bottom:10px;min-height:30px}
.mrow{display:flex;justify-content:space-between;border-top:1px solid #12303f;padding:5px 0;font-size:12px}
.ml{color:#8fb0c6}.mv{font-weight:700}
.why{color:#b9d0e0;font-size:12px;margin-top:12px;background:#06222f;border-left:3px solid #1ba7ff;border-radius:4px;padding:8px 11px}
...
.t-wt{color:#6d8ba0;font-size:10px;margin-top:2px}
...
.cf-h{color:#8fb0c6;font-size:11px;min-height:30px}.cf-v{font-size:19px;font-weight:700;margin:4px 0}.cf-s{color:#6d8ba0;font-size:11px}
