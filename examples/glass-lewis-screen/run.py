...
@media(max-width:820px){.top{flex-wrap:wrap}.kpis{grid-template-columns:1fr 1fr}.war,.cfs{grid-template-columns:1fr}}
...
def main(argv=None):
    ...
    try:
        ...
        html_doc, digest_doc, report_evidence, digest_evidence = portfolio_ev.prepare_pair(
            "glass-lewis-screen", report, html_doc, digest_doc, REPO)
