...
def _ev(t, **kw):
    ...
    if isinstance(scope, str) and scope.startswith("publish.") and (
            t in ("approval", "action") or (t == "recommendation" and base.get("requires_approval") is True)):
...
# (24) CRITICAL (Evidence Graph v1): every publish decision boundary requires a well-formed,
